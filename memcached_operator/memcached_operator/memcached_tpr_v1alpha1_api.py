...
class MemcachedThirdPartyResourceV1Alpha1Api(object):
    ...
    def list_memcached_for_all_namespaces(self, **kwargs):
        """
        ...
        resource_path = '/apis/operator.kubestack.com/v1/memcacheds/'.replace('{format}', 'json')
        path_params = {}
        ...
        (response) = self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='IntstrIntOrString',
    ...
    def read_namespaced_memcached(self, name, namespace, **kwargs):
        """
        ...
        resource_path = '/apis/operator.kubestack.com/v1/namespaces/{namespace}/memcacheds/{name}'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
