...
class TestGetServiceObject():
    ...
    def test_returns_v1_service(self):
        service = get_service_object(self.name, self.namespace)
...
class TestGetDeploymentObject():
    def setUp(self):
        self.name = 'testname123'
        self.namespace = 'testnamespace456'
        self.image = 'testimage:v1'
        self.replicas = 2

    def test_returns_v1beta1_deployment(self):
        deployment = get_deployment_object(
            self.name, self.namespace, self.image, self.replicas)
