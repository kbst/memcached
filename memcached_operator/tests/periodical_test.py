...
class TestCheckExisting():
    ...
    @patch('memcached_operator.memcached_operator.periodical.update_config_map')
    @patch('memcached_operator.memcached_operator.periodical.create_config_map')
    ...
    def test_no_memcached_tprs(self, mock_list_memcached_for_all_namespaces, mock_read_namespaced_service, mock_create_service, mock_cache_version, mock_is_version_cached, mock_update_service, mock_read_namespaced_deployment, mock_create_mcrouter_deployment, mock_create_memcached_deployment, mock_update_mcrouter_deployment, mock_update_memcached_deployment, mock_read_namespaced_config_map, mock_create_config_map, mock_update_config_map):
        ...
        assert mock_read_namespaced_config_map.called is False
        assert mock_create_config_map.called is False
        assert mock_update_config_map.called is False
    ...
    @patch('memcached_operator.memcached_operator.periodical.update_config_map')
    @patch('memcached_operator.memcached_operator.periodical.create_config_map', return_value=client.V1ConfigMap())
    @patch('kubernetes.client.CoreV1Api.read_namespaced_config_map', side_effect=client.rest.ApiException(status=404))
    @patch('memcached_operator.memcached_operator.periodical.update_memcached_deployment')
    @patch('memcached_operator.memcached_operator.periodical.update_mcrouter_deployment')
    @patch('memcached_operator.memcached_operator.periodical.create_memcached_deployment', return_value=client.V1beta1Deployment())
    @patch('memcached_operator.memcached_operator.periodical.create_mcrouter_deployment', return_value=client.V1beta1Deployment())
    ...
    @patch('memcached_operator.memcached_operator.memcached_tpr_v1alpha1_api.MemcachedThirdPartyResourceV1Alpha1Api.list_memcached_for_all_namespaces')
    def test_service_and_deploy_404(self, mock_list_memcached_for_all_namespaces, mock_read_namespaced_service, mock_create_service, mock_cache_version, mock_is_version_cached, mock_update_service, mock_read_namespaced_deployment, mock_create_mcrouter_deployment, mock_create_memcached_deployment, mock_update_mcrouter_deployment, mock_update_memcached_deployment, mock_read_namespaced_config_map, mock_create_config_map, mock_update_config_map):
        # Mock list memcached call with 0 items
        ...
        mock_read_namespaced_config_map.assert_called_once_with(self.name, self.namespace)
    ...
    @patch('memcached_operator.memcached_operator.periodical.update_config_map')
    @patch('memcached_operator.memcached_operator.periodical.create_config_map', return_value=False)
    @patch('kubernetes.client.CoreV1Api.read_namespaced_config_map', side_effect=client.rest.ApiException(status=404))
    @patch('memcached_operator.memcached_operator.periodical.update_memcached_deployment')
    @patch('memcached_operator.memcached_operator.periodical.update_mcrouter_deployment')
    ...
    @patch('kubernetes.client.CoreV1Api.read_namespaced_service', side_effect=client.rest.ApiException(status=404))
    @patch('memcached_operator.memcached_operator.memcached_tpr_v1alpha1_api.MemcachedThirdPartyResourceV1Alpha1Api.list_memcached_for_all_namespaces')
    def test_service_and_deploy_404_yet_create_false(self, mock_list_memcached_for_all_namespaces, mock_read_namespaced_service, mock_create_service, mock_cache_version, mock_is_version_cached, mock_update_service, mock_read_namespaced_deployment, mock_create_mcrouter_deployment, mock_create_memcached_deployment, mock_update_mcrouter_deployment, mock_update_memcached_deployment, mock_read_namespaced_config_map, mock_create_config_map, mock_update_config_map):
        # Mock list memcached call with 0 items
        mock_list_memcached_for_all_namespaces.return_value = self.base_list_result
    ...
    @patch('memcached_operator.memcached_operator.periodical.update_config_map')
    @patch('memcached_operator.memcached_operator.periodical.create_config_map')
    @patch('kubernetes.client.CoreV1Api.read_namespaced_config_map', side_effect=client.rest.ApiException(status=500))
    @patch('memcached_operator.memcached_operator.periodical.logging')
    @patch('memcached_operator.memcached_operator.periodical.update_memcached_deployment')
    @patch('memcached_operator.memcached_operator.periodical.update_mcrouter_deployment')
    @patch('memcached_operator.memcached_operator.periodical.create_memcached_deployment')
    ...
    @patch('memcached_operator.memcached_operator.memcached_tpr_v1alpha1_api.MemcachedThirdPartyResourceV1Alpha1Api.list_memcached_for_all_namespaces')
    def test_service_and_deploy_500(self, mock_list_memcached_for_all_namespaces, mock_read_namespaced_service, mock_create_service, mock_cache_version, mock_is_version_cached, mock_update_service, mock_read_namespaced_deployment, mock_create_mcrouter_deployment, mock_create_memcached_deployment, mock_update_mcrouter_deployment, mock_update_memcached_deployment, mock_logging, mock_read_namespaced_config_map, mock_create_config_map, mock_update_config_map):
    ...
    @patch('memcached_operator.memcached_operator.periodical.update_config_map')
    @patch('memcached_operator.memcached_operator.periodical.create_config_map')
    @patch('kubernetes.client.CoreV1Api.read_namespaced_config_map', return_value=client.V1ConfigMap())
    @patch('memcached_operator.memcached_operator.periodical.update_memcached_deployment')
    @patch('memcached_operator.memcached_operator.periodical.update_mcrouter_deployment')
    @patch('memcached_operator.memcached_operator.periodical.create_memcached_deployment')
    @patch('memcached_operator.memcached_operator.periodical.create_mcrouter_deployment')
    ...
    @patch('memcached_operator.memcached_operator.memcached_tpr_v1alpha1_api.MemcachedThirdPartyResourceV1Alpha1Api.list_memcached_for_all_namespaces')
    def test_service_and_deploy_cached(self, mock_list_memcached_for_all_namespaces, mock_read_namespaced_service, mock_create_service, mock_cache_version, mock_is_version_cached, mock_update_service, mock_read_namespaced_deployment, mock_create_mcrouter_deployment, mock_create_memcached_deployment, mock_update_mcrouter_deployment, mock_update_memcached_deployment, mock_read_namespaced_config_map, mock_create_config_map, mock_update_config_map):
        # Mock list memcached call with 0 items
        mock_list_memcached_for_all_namespaces.return_value = self.base_list_result
        ...
        assert mock_update_service.called is False
        assert mock_update_config_map.called is True
        read_namespaced_deployment_calls = [
            call(self.name, self.namespace),
            call('{}-router'.format(self.name), self.namespace)]
        mock_read_namespaced_deployment.assert_has_calls(read_namespaced_deployment_calls)
    ...
    @patch('memcached_operator.memcached_operator.periodical.update_config_map', return_value=client.V1ConfigMap())
    @patch('memcached_operator.memcached_operator.periodical.create_config_map')
    @patch('kubernetes.client.CoreV1Api.read_namespaced_config_map', return_value=client.V1ConfigMap())
    @patch('memcached_operator.memcached_operator.periodical.update_memcached_deployment', return_value=client.V1beta1Deployment())
    @patch('memcached_operator.memcached_operator.periodical.update_mcrouter_deployment', return_value=client.V1beta1Deployment())
    @patch('memcached_operator.memcached_operator.periodical.create_memcached_deployment')
    @patch('memcached_operator.memcached_operator.periodical.create_mcrouter_deployment')
    @patch('kubernetes.client.ExtensionsV1beta1Api.read_namespaced_deployment', return_value=client.V1beta1Deployment())
    ...
    @patch('kubernetes.client.CoreV1Api.read_namespaced_service', return_value=client.V1Service())
    @patch('memcached_operator.memcached_operator.memcached_tpr_v1alpha1_api.MemcachedThirdPartyResourceV1Alpha1Api.list_memcached_for_all_namespaces')
    def test_service_and_deploy_not_cached(self, mock_list_memcached_for_all_namespaces, mock_read_namespaced_service, mock_create_service, mock_cache_version, mock_is_version_cached, mock_update_service, mock_read_namespaced_deployment, mock_create_mcrouter_deployment, mock_create_memcached_deployment, mock_update_mcrouter_deployment, mock_update_memcached_deployment, mock_read_namespaced_config_map, mock_create_config_map, mock_update_config_map):
        # Mock list memcached call with 0 items
        mock_list_memcached_for_all_namespaces.return_value = self.base_list_result
    ...
    @patch('memcached_operator.memcached_operator.periodical.update_config_map', return_value=False)
    @patch('memcached_operator.memcached_operator.periodical.create_config_map')
    @patch('kubernetes.client.CoreV1Api.read_namespaced_config_map', return_value=client.V1ConfigMap())
...
class TestCollectGargabe():
    def setUp(self):
        ...
        cm_list = client.V1ConfigMapList()
        ...
        memcached_deploy = client.V1beta1Deployment()
        ...
        memcached_deploy.metadata.labels = {
            ...
            'heritage': 'kubestack.com',
            'cluster': self.name}
        mcrouter_deploy = client.V1beta1Deployment()
    ...
    @patch('memcached_operator.memcached_operator.periodical.delete_config_map')
    @patch('kubernetes.client.CoreV1Api.list_config_map_for_all_namespaces')
    ...
    def test_services_and_deployments_exceptions(self, mock_list_service_for_all_namespaces, mock_delete_service, mock_read_namespaced_memcached, mock_list_deployment_for_all_namespaces, mock_reap_deployment, mock_list_config_map_for_all_namespaces, mock_delete_config_map):
        # Mock service list exception
        mock_list_service_for_all_namespaces.side_effect = client.rest.ApiException()

        # Mock config_map list exception
        mock_list_config_map_for_all_namespaces.side_effect = client.rest.ApiException()
        ...
        assert mock_delete_config_map.called is False
    ...
    @patch('memcached_operator.memcached_operator.periodical.delete_service')
    @patch('kubernetes.client.CoreV1Api.list_service_for_all_namespaces')
    def test_no_services_and_deployments(self, mock_list_service_for_all_namespaces, mock_delete_service, mock_read_namespaced_memcached, mock_list_deployment_for_all_namespaces, mock_reap_deployment, mock_list_config_map_for_all_namespaces, mock_delete_config_map):
        ...
        # Mock emtpy config map list
        empty_cm_list = deepcopy(self.correct_cm_list)
        empty_cm_list.items = []
        mock_list_config_map_for_all_namespaces.return_value = empty_cm_list
    ...
    @patch('memcached_operator.memcached_operator.periodical.delete_service')
    @patch('kubernetes.client.CoreV1Api.list_service_for_all_namespaces')
    def test_expected_services_and_deployments(self, mock_list_service_for_all_namespaces, mock_delete_service, mock_read_namespaced_memcached, mock_list_deployment_for_all_namespaces, mock_reap_deployment, mock_list_config_map_for_all_namespaces, mock_delete_config_map):
        # Mock service list
        mock_list_service_for_all_namespaces.return_value = self.correct_svc_list

        # Mock config map list
        mock_list_config_map_for_all_namespaces.return_value = self.correct_cm_list
    ...
    @patch('memcached_operator.memcached_operator.periodical.delete_service')
    @patch('kubernetes.client.CoreV1Api.list_service_for_all_namespaces')
    def test_unexpected_services_and_deployments(self, mock_list_service_for_all_namespaces, mock_delete_service, mock_read_namespaced_memcached, mock_list_deployment_for_all_namespaces, mock_reap_deployment, mock_list_config_map_for_all_namespaces, mock_delete_config_map):
        # Mock service list
        mock_list_service_for_all_namespaces.return_value = self.correct_svc_list
    ...
    @patch('memcached_operator.memcached_operator.periodical.delete_service')
    @patch('kubernetes.client.CoreV1Api.list_service_for_all_namespaces')
    def test_read_services_and_deployments_500(self, mock_list_service_for_all_namespaces, mock_delete_service, mock_read_namespaced_memcached, mock_list_deployment_for_all_namespaces, mock_reap_deployment, mock_logging, mock_list_config_map_for_all_namespaces, mock_delete_config_map):
        # Mock service list
        mock_list_service_for_all_namespaces.return_value = self.correct_svc_list
        ...
        assert mock_reap_deployment.called is False
        assert mock_logging.exception.called is True
        assert mock_logging.exception.call_count == 4
